...
const Example = () => {
    ...
    return (
        <div className="group p-10 border border-red-50">
            ...
            <input
                type="text"
                className="py-3 px-3 border border-[#ccc] outline-none rounded-xl m-3 lg:focus:border-[#ffa400] transition-all" />
            <input
                type="checkbox"
            ...
            />
            {
                names.map((name, index) => {
                    return (
                        <div className="odd:bg-red-500">{name}</div>
                    )
                })
            }
            {/* hover:bg-red */}
            ...
            */}
            ...
            <h1>Want anything to be easy with LablesVPN.</h1>
        </div>
    )
}
